...
public class UserDao {
	...
	//Method used for searching book with any substring of book name
	public List<BookDto> searchBook(String bookName) throws SQLException
	{
		...
		//Method used for showing reviews of book selected
	public List<String> showReview(int id) throws SQLException
	{
		...
		//Method used for adding reviews for that book 
